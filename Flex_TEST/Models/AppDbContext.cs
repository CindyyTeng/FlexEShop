        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Activities>(entity =>
            {
                entity.HasKey(e => e.ActivityId)
                    .HasName("PK__Activiti__45F4A791808FC894");
            ...
            modelBuilder.Entity<ActivityStatuses>(entity =>
            {
                entity.HasKey(e => e.ActivityStatusId)
                    .HasName("PK__Activity__860CFEADC4AD76B7");

                entity.HasIndex(e => e.ActivityStatusDescription, "UQ__Activity__732635EC6E865412")
                    .IsUnique();
            ...
            modelBuilder.Entity<AlternateAddresses>(entity =>
            {
                entity.HasKey(e => e.AddressId)
                    .HasName("PK__Alternat__091C2AFB0CBA320E");

                entity.HasIndex(e => e.fk_MemberId, "UQ__Alternat__3B54230C9E831554")
                    .IsUnique();
            ...
            modelBuilder.Entity<Branches>(entity =>
            {
                entity.HasKey(e => e.BranchId)
                    .HasName("PK__Branches__A1682FC518826879");

                entity.HasIndex(e => e.BranchName, "UQ__Branches__3903DB03C8510D8E")
                    .IsUnique();

                entity.HasIndex(e => e.BranchAddress, "UQ__Branches__F50DE17AE7FB4C90")
                    .IsUnique();
            ...
            modelBuilder.Entity<CustomizedOrders>(entity =>
            {
                entity.HasKey(e => e.Customized_Id)
                    .HasName("PK__Customiz__AFADABDD0FC94062");
                ...
                entity.HasOne(d => d.Customized_EdgeProtectionNavigation)
                    ...
                    .HasConstraintName("FK__Customize__Custo__3587F3E0");
                ...
                entity.HasOne(d => d.Customized_EyeletNavigation)
                    ...
                    .HasConstraintName("FK__Customize__Custo__3493CFA7");
                ...
                entity.HasOne(d => d.Customized_RearNavigation)
                    ...
                    .HasConstraintName("FK__Customize__Custo__367C1819");
                ...
                entity.HasOne(d => d.Customized_ToeNavigation)
                    ...
                    .HasConstraintName("FK__Customize__Custo__3864608B");
                ...
                entity.HasOne(d => d.Customized_TongueNavigation)
                    ...
                    .HasConstraintName("FK__Customize__Custo__37703C52");
            ...
            modelBuilder.Entity<Customized_materials>(entity =>
            {
                entity.HasKey(e => e.Shoesmaterial_Id)
                    .HasName("PK__Customiz__06EFE12D7BD213F3");
            ...
            modelBuilder.Entity<Discounts>(entity =>
            {
                ...
                entity.Property(e => e.DiscountDescription).HasMaxLength(50);
            ...
            modelBuilder.Entity<MemberPoints>(entity =>
            {
                ...
                entity.HasIndex(e => e.fk_PointHistoryId, "UQ__MemberPo__70594D45FBF5D88E")
                    .IsUnique();
                ...
                entity.HasOne(d => d.fk_PointHistory)
                    .WithOne(p => p.MemberPoints)
                    .HasForeignKey<MemberPoints>(d => d.fk_PointHistoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__MemberPoi__fk_Po__7EF6D905");
            });
            ...
            modelBuilder.Entity<MembershipLevels>(entity =>
            {
                ...
                entity.HasMany(d => d.fk_Privilege)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("fk_LevelId", "fk_PrivilegeId").HasName("PK__Membersh__580C8EAA07200D2A");
            ...
            modelBuilder.Entity<OneToOneReservations>(entity =>
            {
                entity.HasKey(e => e.ReservationId)
                    .HasName("PK__OneToOne__B7EE5F24AE765DBC");
            ...
            {
                entity.HasKey(e => e.ReservationId)
                    .HasName("PK__Reservat__B7EE5F2409A81B34");

                entity.HasIndex(e => e.ReservationStatusDescription, "UQ__Reservat__ADF40EA64D596DF0")
                    .IsUnique();
            ...
            modelBuilder.Entity<ShoesCategories>(entity =>
            {
                entity.HasKey(e => e.ShoesCategoryId)
                    .HasName("PK__ShoesCat__A478678BE24BD1AE");
            ...
            modelBuilder.Entity<ShoesColorCategories>(entity =>
            {
                entity.HasKey(e => e.ShoesColorId)
                    .HasName("PK__ShoesCol__BB1469D45C840982");
            ...
            modelBuilder.Entity<ShoesPictures>(entity =>
            {
                entity.HasKey(e => e.ShoesPicture_Id)
                    .HasName("PK__ShoesPic__DF35EBA4EBBB6145");
            ...
            modelBuilder.Entity<SpeakerFields>(entity =>
            {
                entity.HasKey(e => e.FieldId)
                    .HasName("PK__SpeakerF__C8B6FF0752102C91");
            ...
            modelBuilder.Entity<Speakers>(entity =>
            {
                entity.HasKey(e => e.SpeakerId)
                    .HasName("PK__Speakers__79E757595E888C22");
                ...
                entity.HasOne(d => d.fk_SpeakerBranch)
                    ...
                    .HasConstraintName("FK__Speakers__fk_Spe__6442E2C9");

                entity.HasOne(d => d.fk_SpeakerField)
                    .WithMany(p => p.Speakers)
                    .HasForeignKey(d => d.fk_SpeakerFieldId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Speakers__fk_Spe__65370702");
            });
            ...
            modelBuilder.Entity<Suppliers>(entity =>
            {
                entity.HasKey(e => e.SupplierId)
                    .HasName("PK__Supplier__4BE666B48E79B211");

                entity.HasIndex(e => e.SupplierCompanyNumber, "UQ__Supplier__AE8E9B412BD935D5")
                    .IsUnique();
